  ...
  function getBooks(){
    ...
    function(AllRecords){
        ...
        function(CurrentRecord){
            ...
            var No_of_books = CurrentRecord.val().No_of_books;
            addItemsToTable(title,author,date,barcode,No_of_books);
  ...
  function addItemsToTable(title,author,date,barcode,No_of_books){
      ...
      for(var i = 1; i < table.rows.length; i++)
        {
            table.rows[i].onclick = function(){
                ...
                var countB = this.cells[4].innerHTML;
                ...
                document.getElementById('countB').value = countB;

                console.log("Book: " + rowIndex + " " + titleB + " " + authorB + " " + dateB + " " + barcodeB + " " + countB );
            }
        }
        ...
        //update book
        var title,author,barcode,date,count;
        function updateBook(){
